...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#1a120b] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    ...
                    (pathname === '/' && 'bg-primary dark:bg-meta-4')
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/admin/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <FaUser/>
                  Profile
              ...
              <li>
                <NavLink
                  to="/admin/location"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('location') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <FaLocationDot/>
                  Location Management
              ...
              {/* <!-- Menu Item Villa Registration --> */}
              <li>
                <NavLink
                  to="/admin/villa"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('villa') &&
                    'bg-primary dark:bg-meta-4'
                  }`}
                >
                  {/* <img src={} alt="" /> */}
                  <MdVilla className='w-5 h-5' />
                  Villa Management
                </NavLink>
              </li>
              {/* <!-- Menu Item Villa Registration --> */}

              {/* <!-- Menu Item Camping Registration --> */}
              <li>
                <NavLink
                  to="/admin/camp"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                ...
                >
                  <GiForestCamp className='w-5 h-5' />
                  Camp Management
                </NavLink>
              </li>
              {/* <!-- Menu Item Camp Registration --> */}

              {/* <!-- Menu Item Trek Registration --> */}
              <li>
                <NavLink
                  to="/admin/trek"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('trek') &&
                    'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <PiMountainsFill/>
              ...
              <li>
                <NavLink
                  to="/admin/user"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('user') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <BsStack/>
                  User Management
              ...
              <li>
                <NavLink
                  to="/admin/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/admin/settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('settings') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/admin/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-primary dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
