...
import CampingForm from './RegistrationForms/CampingForm';
...
const CampManagement = () => {
  ...
  const headerElement = (
    <div className="inline-flex align-items-center justify-content-center gap-2">
      <span className="font-bold white-space-nowrap">Add Camp</span>
    </div>
  );
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-3">
        <h2 className="font-bold text-2xl ">Camping Management</h2>
        <div>
          <button
